    ...
    <header class="w-full h-[104px] absolute top-0 left-0 z-10" :class="route.name == 'login','register','cart' ? 'bg-[#01101D]' : ''">
      <div class="w-full h-full flex justify-around items-center">
        ...
        <div class="flex text-white">
          <div v-if="username" class="flex items-center cursor-pointer" @click="profile"><svg-icon type="mdi" :path="mdiAccount" class="text-white w-[27px] h-[27px]" /><span class="pl-[5px]">{{ username }}</span></div>
