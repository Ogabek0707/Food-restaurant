        ...
        <section id="login" class="w-full h-[100%] py-[80px] bg-gray-100">
            <div class="flex justify-center gap-[60px]">
                <div class=" p-[24px] w-[610px] rounded-[24px]">
                    <h1 class="text-black text-[50px] text-center font-semibold">My information</h1>
                    <div class="flex items-center gap-[20px]">
                        <h1 class="text-[25px] font-semibold">Name:</h1>
                        <p class="text-[20px]">{{ name }}</p>
                    </div>
                    <div class="flex items-center gap-[20px]">
                        <h1 class="text-[25px] font-semibold">Phone:</h1>
                        <p class="text-[20px]">{{ phone }}</p>
                    </div>
                    <button class="bg-red-600 flex items-center gap-[5px] py-[10px] px-[12px] text-white text-[18px] font-semibold mt-[10px] rounded-[5px]" @click="logOut"><svg-icon type="mdi" :path="mdiLogout"></svg-icon> Log out</button>
...
import { mdiLogout, mdiArrowTopRight } from '@mdi/js';
